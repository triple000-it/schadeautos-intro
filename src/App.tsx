      ...
      <header className="header">
        <div className="container">
          ...
          <div className="contact-info">
            <a href="https://wa.me/31687480593" target="_blank" rel="noopener noreferrer" className="whatsapp-button" aria-label="WhatsApp">
              <svg fill="#2c5765" width="24" height="24" viewBox="0 0 24 24">
            ...
            <a href="mailto:info@sloopautos.online" className="email-button" aria-label="Email">
              <svg fill="#2c5765" width="24" height="24" viewBox="0 0 24 24">
